...
const ProfileText = ({ visible, titleId }) => (
  <Fragment>
    ...
    <Text className={styles.description} data-visible={visible} size="l" as="p">
      I’m Sikandar, a Python Backend Developer with 3 years of experience building production-grade systems. I specialize in RESTful API development using FastAPI and Django REST Framework, microservices architecture, JWT/OAuth authentication (RBAC/ABAC/ReBAC), and distributed task processing with Celery and Redis.
    </Text>
    <Text className={styles.description} data-visible={visible} size="l" as="p">
            ...
            <div className={styles.column}>
              ...
              <div className={styles.image}>
                <Image
                  ...
                  srcSet={`${sikandarImg} 480w, ${sikandarImg} 960w`}
                  width={960}
                  height={1280}
                  sizes={`(max-width: ${media.mobile}px) 100vw, 480px`}
                  alt="Muhammad Sikandar Mustafa — Software Engineer & Python Backend Developer"
                />
